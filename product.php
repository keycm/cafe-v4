    ...
    <div class="footer-main">
        <div class="footer-left">
            ...
            <p class="footer-links">
                <a href="index.php" class="link-1">Home</a><a href="#">Blog</a><a href="#">Pricing</a>
        ...
        <div class="footer-center">
            ...
            <div><i class="fa fa-envelope"></i><p><a href="mailto:support@company.com">Saplot09209@gmail.com</a></p></div>
        </div>
        <div class="footer-right">
            ...
            <div class="footer-icons">
                ...
                <a href="#"><i class="fab fa-linkedin"></i></a><a href="#"><i class="fab fa-github"></i></a>
            </div>
        </div>
    </div>
